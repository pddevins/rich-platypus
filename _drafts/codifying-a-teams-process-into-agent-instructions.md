...
investigate a ticket, refactor safely, review a change, chase something down in production.
Fewer of these than I expected, and they get the heaviest use.

**Per-feature planning documents.** One per significant piece of work, written before the
work. This is the category I didn't anticipate at all when we started, and it's now the one
I'd least want to give up.
...
writes anything down. Past a certain size, everything that isn't explicit is a coin flip.
Writing instructions for a machine is just an unusually unforgiving way of being forced to
make things explicit, because a machine cannot infer the bits you left out and will not ask
a colleague.
...
It's that coding, security, and correctness standards now **migrate**. Across projects and
...
defaults, without anyone having to remember the local deviations.
