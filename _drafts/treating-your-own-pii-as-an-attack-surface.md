...
An attack surface is the set of points where an adversary can interact with a system. It
is reduced by removing entry points, not by hardening every one of them.
...
That combinatorial property is the whole game. Your date of birth is nearly harmless.
Your mother's maiden name is nearly harmless. Your childhood address is nearly harmless.
Together they are a successful call to a support desk.
...
Rank by what an attacker can do with it.
...
There's no technical remedy. What works is asking, specifically and without making it
weird — most people will honour "please don't tag my kids" and simply hadn't considered
it. What doesn't work is treating this as a solved problem because your own settings are
tidy.
...
Two things I actually changed, since a post like this is worthless without them.
...
useful, and they're exactly what a social profile is designed to publish. A birthday is a
security question. A routine is a physical-safety concern. Location is both.
